...
public class ManageCourseCatalogJPanel extends javax.swing.JPanel {
    ...
    public void refreshTable() {
        ...
        for (Course p : supplier.getCourseCatalog().getCourseList()) {
            Object row[] = new Object[3];
            row[0] = p;
            row[1] = p.getCredits();
            row[2] = p.getCoursePrice();
            model.addRow(row);
        }
    }
    ...
    private void initComponents() {
        ...
        lblTitle.setText("Manage Course Catalog");
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        Course s = (Course) tblProductCatalog.getValueAt(selectedRowIndex, 0);
        supplier.getCourseCatalog().removeCourse(s);
        refreshTable();
